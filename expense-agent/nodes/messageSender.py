...
If the SQL query result is empty, it means there are no expenses matching the user's request. In this case, generate a message informing the user that no expenses were found.
