...
- "I spent 20 euros on lunch today" (intent: add_expense)
- "How much did I spend on groceries last month?" (intent: get_expenses)
- "10 euros for Kebab" (intent: add_expense)
- "15 euros Taxi" (intent: add_expense)
- "10 euros" (intent: add_expense)
- "30" (intent: add_expense)
- "69 € Marseille" (intent: add_expense)
- "What did I spend on food last week?" (intent: get_expenses_by_category)
